...
Module.prototype.getData = function () {
  return this.dataSource.getData().then(_.bind(function (dataSource) {
    ...
    this.dataSource.formattedData = presentation.formatKeys(this);
    this.dataSource.tabularData = presentation.tabularData(this);
...
Module.prototype.resolve = function () {
  if (this.isSupported(this.moduleConfig['module-type'])) {
    ...
    return Q.reject('Module not supported');
  }
};
